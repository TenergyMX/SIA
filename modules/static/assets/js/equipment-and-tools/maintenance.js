class EquipmentsMaintenance {
    constructor(options) {
        ...
        const defaultOptions = {
            ...
            table: {
                ...
                ajax: {
                    url: "/get_equipments_maintenance/",
                    dataSrc: "data",
                    data: {},
                },
                columns: [
    ...
    setupEventHandlers() {
        ...
        $(document).on("click", "[data-sia-equipment-maintenance]", function (e) {
            var obj = $(this);
            var option = obj.data("sia-equipments-maintenance");
