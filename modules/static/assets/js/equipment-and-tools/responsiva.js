...
document.getElementById('canvas-signature-btn-clear-almacen').addEventListener('click', function() {
...
function status_responsiva() {
    ...
    try {
        ...
        for (let i = 0; i < pixelData.length; i += 4) {
            if (pixelData[i + 3] !== 0) { // Comprobar el componente alfa
                hasDrawing = true;
                break;
            }
        }
