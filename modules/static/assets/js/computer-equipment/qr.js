$(document).ready(function () {
    console.log("se cargó la página de qr correctamente");
    const computerSystemId = $('[data-computer-qr="qr-info"]').data("computersystem_id");

    console.log("computerSystemId:", computerSystemId); 
...
$(document).on("click", "[data-computer-qr='qr-info']", function () {
    ...
    console.log("este es el id de la computadora:", computerSystemId);
    if (!computerSystemId) {
